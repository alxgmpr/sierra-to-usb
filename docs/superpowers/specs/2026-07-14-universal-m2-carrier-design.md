...
- RTL8125BG: single 3.3 V supply (internal regs), 25 MHz crystal, 93C46 EEPROM footprint (optional MAC/config), LED0/1 → magjack LEDs (excluded from LED kill rail), MDI 4 pairs (100 Ω diff) → magjack.
